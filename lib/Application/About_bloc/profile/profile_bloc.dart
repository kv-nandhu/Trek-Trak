...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ProfileBloc(
    ...
    on<AddAddressEvent>(_addressUpdate);
  ...
  FutureOr<void> _bioUpdate(
      AddBioEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _addressUpdate(
      AddAddressEvent event, Emitter<ProfileState> emit) async {
    try {
      // Update miniBio in Firestore
      await FirestoreService()
          .updateUserAddress(event.address, event.companyAddress);
      var user = await UserProfileRepo().getUser();
      print(user);
      print("check 2");
      emit(UserProfileLoadState(user: user!));
      print(event.address);
      print(event.companyAddress);
    } catch (e) {
      print(e);
    }
  }

  FutureOr<void> _addChat(
      ChatnessEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _addSmoke(
      SmokingEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _addVehicleNumber(
      VehicleNumberEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _addVehicleModel(
      VehicleModelEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _addVehicleBrand(
      VehilceBrandEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _addVehicleColor(
      VehicleColorEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _addVehicleType(
      VehilceTypeEvent event, Emitter<ProfileState> emit) async {
    try {
...
//--------------profile update -----------------------
  ...
  FutureOr<void> _updateUserDob(
      UserDobEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _updateUserNumber(
      UserNumberEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _updateUserEmail(
      UserEmailEvent event, Emitter<ProfileState> emit) async {
    try {
  ...
  FutureOr<void> _updateUserProfileImage(
      UserImageEvent event, Emitter<ProfileState> emit) async {
    try {
