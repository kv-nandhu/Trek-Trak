...
print(rideAccepted.time!);
print(rideAccepted.date!);
print(rideAccepted.dropitlocation!);
print(rideAccepted.passengercount!);
print(rideAccepted.expence!);
print(rideAccepted.pickuplocation!);
print(rideAccepted.uid!);
print(rideAccepted.image!);
print(rideAccepted.uname!);
print(rideAccepted.fromuid!);
