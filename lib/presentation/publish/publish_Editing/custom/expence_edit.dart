...
class CalculateMileageEdit extends StatefulWidget {
  ...
  @override
  _CalculateMileageEditState createState() => _CalculateMileageEditState();
}

class _CalculateMileageEditState extends State<CalculateMileageEdit> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                String expence = _expense.toStringAsFixed(2);
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('expence updated successfully!'),
                  ),
                );
                _saveExpense();
              },
