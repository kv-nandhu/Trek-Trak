...
class DropLocationEdit extends StatefulWidget {
  final String fromuid;

  const DropLocationEdit({super.key, required this.fromuid}); 
  @override
  _DropLocationEditState createState() => _DropLocationEditState();
}

class _DropLocationEditState extends State<DropLocationEdit> {
                ...
                onPressed: () {
                  BlocProvider.of<RidePublishBloc>(context).add(
                    DropLocationEvent(
                      ...
                      droplongitude: currentDropLongitude.toString(), fromuid: widget.fromuid,
                    ),
                  );
                  Navigator.pop(
                    context,
