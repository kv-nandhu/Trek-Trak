...
class KeralaLocationsEDit extends StatefulWidget {
  final String fromuid;

  const KeralaLocationsEDit({super.key, required this.fromuid});
  @override
  _KeralaLocationsEDitState createState() => _KeralaLocationsEDitState();
}

class _KeralaLocationsEDitState extends State<KeralaLocationsEDit> {
                ...
                onPressed: () {
                 BlocProvider.of<RidePublishBloc>(context).add(
                    PickLocationEvent(
                      ...
                      picklongitude: currectPickLongitude.toString(), fromuid: widget.fromuid,
                    ),
                  );
                  Navigator.pop(
                    context,
